    ...
    <div className='w-full flex flex-col h-auto justify-center items-center'>
      ...
      <section className="w-full my-6 ">
        <div className="w-full flex items-center justify-between">
          <p className="text-2xl font-semibold capitalize text-white relative before:absolute before:rounded-lg before:content before:w-32 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-pink-300 to-pink-900 transition-all ease-in-out duration-100">
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-pink-300 hover:bg-pink-600 cursor-pointer  hover:shadow-lg flex items-center justify-center"
