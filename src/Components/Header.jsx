...
const Header = () => {
  ...
  return (
    <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 shadow-md bg-black'>
        {/* Desktop and tablet */}
        <div className='hidden md:flex w-full h-full items-center justify-between'>
            ...
            <div className='flex items-center gap-8'>
                <motion.ul initial={{opacity:0 ,x:200}}
                    ...
                    <li ><Link to={"/"} className='text-base text-white hover:text-pink-300 cursor-pointer duration-100 transition-all ease-in-out'>Home</Link></li>
                    <li ><Link to="menu"  span={true} smooth={true} className='text-base text-white hover:text-pink-300 cursor-pointer duration-100 transition-all ease-in-out'>Menu</Link></li>
                    <li className='text-base text-white hover:text-pink-300 cursor-pointer duration-100 transition-all ease-in-out'>About Us</li>
                    <li className='text-base text-white hover:text-pink-300 cursor-pointer duration-100 transition-all ease-in-out'>Service</li>
                </motion.ul>

                <div className='relative flex items-center justify-center'  onClick={showCart}>
                    <MdShoppingBasket className='text-pink-200 text-2xl  cursor-pointer' />
                    {
            ...
            <div className='relative flex gap-8'>
...

                    {
                        ...
                        <ul className="flex flex-col items-start ">
                            ...
                            <li className='w-full text-base text-textColor hover:text-pink-300 cursor-pointer duration-100 transition-all ease-in-out hover:bg-slate-200 px-4 py-2'onClick={() => setIsmenu(false)}>Service</li>
                        </ul>
